...
## Current State (11/07/2026, later session — UNCOMMITTED)
...
- Not yet committed or pushed. 103 files changed (237 insertions, 126 deletions) sitting in the working tree.

## Next Steps
- Commit and push the mobile-sticky-header / progress-bar / root-relative-script fixes above.
...
## Session Log
- 11/07/2026 (later) | Fixed mobile sticky header (overflow-x:hidden on body was killing position:sticky — switched to fixed), fixed progress-bar.js stale documentHeight cache, changed script src to root-relative across 103 pages so it resolves correctly on nested URLs. UNCOMMITTED.
