...
(function () {
  ...
  var triggerSvg =
    ...
    '<circle cx="15.5" cy="19" r="1.25" fill="#9F7AEA"/>' +
    '<circle cx="19.5" cy="19" r="1.25" fill="#9F7AEA"/>' +
    '<circle cx="23.5" cy="19" r="1.25" fill="#9F7AEA"/>' +
    '</svg>';
